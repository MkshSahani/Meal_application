...
const availableCategories = [
  ...
  Category(id: "c6", title: "Exotic", color: Colors.lightBlue),
  Category(id: "c7", title: "Breakfast", color: Colors.lightGreen),
  Category(id: "c8", title: "French", color: Colors.pink),
  Category(id: "c9", title: "Summer", color: Colors.teal),
  Category(id: "c10", title: "Asain", color: Colors.green)
];
